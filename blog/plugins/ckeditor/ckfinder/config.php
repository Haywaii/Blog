...
function CheckAuthentication()
{
	...
	return (isset($_SESSION['user']) AND !empty($_SESSION['user'])); #SFI
}
...
$baseUrl = $_SESSION['ckeditor']['racine'];
$baseDir = str_replace('plugins/ckeditor/ckfinder', '', str_replace('\\', '/', dirname(__FILE__))).'/';
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . $_SESSION['ckeditor']['images'] . '_thumbs',
		'directory' => $baseDir . $_SESSION['ckeditor']['images'] . '_thumbs',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . $_SESSION['ckeditor']['documents'].$_SESSION['ckeditor']['userfolders'],
		'directory' => $baseDir . $_SESSION['ckeditor']['documents'].$_SESSION['ckeditor']['userfolders'],
		'maxSize' => "16M",
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . $_SESSION['ckeditor']['images'].$_SESSION['ckeditor']['userfolders'],
		'directory' => $baseDir . $_SESSION['ckeditor']['images'].$_SESSION['ckeditor']['userfolders'],
		'maxSize' => "16M",
...
*/
$config['HideFolders'] = Array(".svn", "CVS", "_thumbs", ".tmb");
