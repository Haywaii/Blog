   			...
   			<div class="alignright">
      			<div class="newer-older">
      				<?php echo $plxShow->callHook('prevNext',array(
      					true,
      					'<a href="#prevUrl" rel="prev"><img src="'.$plxMotor->urlRewrite().'themes/Liberty/images/forword.png" alt="&laquo;" title="#prevTitle"></a>'."\n\t\t\t\t\t",
      					'<a href="#nextUrl" rel="next"><img  src="'.$plxMotor->urlRewrite().'themes/Liberty/images/next.png" alt="&raquo;" title="#nextTitle"></a>'
      				)); ?>
