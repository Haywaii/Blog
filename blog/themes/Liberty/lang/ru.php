...
'TOP'					=> 'Вверх',
'SUBSCRIBE_RSS'			=> 'Подписаться на RSS',
'ENJOY_POST'			=> 'Если вам понравилась должность, убедитесь, что вы подписаться на ленту RSS.',
...
'REPLY'					=> 'Reply',
'CANCEL_REPLY'			=> 'Click here to cancel reply.',
